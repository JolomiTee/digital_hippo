...
var get_payload_1 = require("../../app/get-payload");
var account_credentials_validator_1 = require("../validators/account-credentials-validator");
    ...
    verifyEmail: trpc_1.publicProcedure
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    pld = _c.sent();
                    return [4 /*yield*/, pld.verifyEmail({
                            collection: "users",
                            token: token,
                        })];
                case 2:
