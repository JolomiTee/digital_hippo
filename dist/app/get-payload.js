...
var getPayloadClient = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (_a) {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!"".concat(process.env.PAYLOAD_SECRET)) {
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ email: {
                            ...
                            }, secret: "".concat(process.env.PAYLOAD_SECRET), local: (initOptions === null || initOptions === void 0 ? void 0 : initOptions.express) ? false : true }, (initOptions || {})));
                    }
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
